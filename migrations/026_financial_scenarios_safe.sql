-- Migration 026: Financial Scenarios & Simulations System (SAFE VERSION)
...
CREATE INDEX IF NOT EXISTS idx_financial_scenarios_user ON financial_scenarios(user_id);
CREATE INDEX IF NOT EXISTS idx_financial_scenarios_status ON financial_scenarios(status);
...
-- Index for performance
CREATE INDEX IF NOT EXISTS idx_scenario_assumptions_scenario ON scenario_assumptions(scenario_id);
CREATE INDEX IF NOT EXISTS idx_scenario_assumptions_category ON scenario_assumptions(category);
...
CREATE INDEX IF NOT EXISTS idx_scenario_results_date ON scenario_results(calculation_date);
CREATE INDEX IF NOT EXISTS idx_scenario_results_combined ON scenario_results(scenario_id, calculation_date);
...
-- Index for performance
CREATE INDEX IF NOT EXISTS idx_scenario_comparisons_user ON scenario_comparisons(user_id);
...
CREATE INDEX IF NOT EXISTS idx_scenario_templates_public ON scenario_templates(is_public);
...
DROP POLICY IF EXISTS "Users can view their own scenarios" ON financial_scenarios;
DROP POLICY IF EXISTS "Users can create their own scenarios" ON financial_scenarios;
DROP POLICY IF EXISTS "Users can update their own scenarios" ON financial_scenarios;
DROP POLICY IF EXISTS "Users can delete their own scenarios" ON financial_scenarios;

DROP POLICY IF EXISTS "Users can view assumptions for their scenarios" ON scenario_assumptions;
DROP POLICY IF EXISTS "Users can create assumptions for their scenarios" ON scenario_assumptions;
DROP POLICY IF EXISTS "Users can update assumptions for their scenarios" ON scenario_assumptions;
DROP POLICY IF EXISTS "Users can delete assumptions for their scenarios" ON scenario_assumptions;

DROP POLICY IF EXISTS "Users can view results for their scenarios" ON scenario_results;
DROP POLICY IF EXISTS "Users can create results for their scenarios" ON scenario_results;

DROP POLICY IF EXISTS "Users can view their own comparisons" ON scenario_comparisons;
DROP POLICY IF EXISTS "Users can create their own comparisons" ON scenario_comparisons;
DROP POLICY IF EXISTS "Users can update their own comparisons" ON scenario_comparisons;
DROP POLICY IF EXISTS "Users can delete their own comparisons" ON scenario_comparisons;

DROP POLICY IF EXISTS "Everyone can view public templates" ON scenario_templates;
DROP POLICY IF EXISTS "Users can create their own templates" ON scenario_templates;
DROP POLICY IF EXISTS "Users can update their own templates" ON scenario_templates;
DROP POLICY IF EXISTS "Users can delete their own templates" ON scenario_templates;
...
DROP TRIGGER IF EXISTS update_financial_scenarios_updated_at ON financial_scenarios;
DROP TRIGGER IF EXISTS update_scenario_assumptions_updated_at ON scenario_assumptions;
DROP TRIGGER IF EXISTS update_scenario_comparisons_updated_at ON scenario_comparisons;
...
DELETE FROM scenario_templates WHERE is_public = true AND user_id IS NULL;
