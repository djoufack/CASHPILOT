# Task 019 - [MOYENNE] : Service Declaration TVA

## Fichier(s) a creer
- `src/services/vatDeclarationService.js`

## Probleme
CashPilot ne genere pas automatiquement les declarations TVA.

## Solution
Creer un service pour generer les declarations TVA au format CA3 (France) et Intervat (Belgique).
...
- [ ] calculateVATBreakdown fonctionne
- [ ] Format CA3 France genere
- [ ] Format Intervat Belgique genere
