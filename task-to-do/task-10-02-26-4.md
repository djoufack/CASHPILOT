...
## Résultat
- Tables `accounting_plans` et `accounting_plan_accounts` créées avec indexes et RLS
- 3 policies RLS : SELECT globaux + privés, INSERT privés, SELECT comptes via plans accessibles
