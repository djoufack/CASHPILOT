# Task 013 - [FAIBLE] : Beta Features Hook

## Fichier(s) a creer
- `src/hooks/useBetaFeatures.js`

## Probleme
CashPilot n'a pas de systeme de feature flags pour les fonctionnalites beta.

## Solution
Creer un hook pour gerer les fonctionnalites beta par utilisateur.
...
- [ ] Fichier src/hooks/useBetaFeatures.js cree
- [ ] Liste BETA_FEATURES definie
- [ ] isFeatureEnabled() fonctionne
- [ ] enrollInBeta() cree l'enregistrement
- [ ] submitFeedback() enregistre le feedback
- [ ] Build passe
