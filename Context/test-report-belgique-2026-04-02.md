# Rapport de test - Belgique (PCMN)

Date: 2026-04-02
Compte: pilotage.be.demo@cashpilot.cloud
Referentiel: PCMN
...
- Cartographie: CSP bloque les tuiles OpenStreetMap
...
- Aucun module KO
- Meme pattern d'anomalies que le compte France
