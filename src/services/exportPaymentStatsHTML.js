...
<body>
  <div class="header">
    ...
    <p>${companyName || 'Your Company'} - ${new Date().toLocaleDateString(getLocale())}</p>
  </div>
  ...
  <div class="footer">
    <p>Payment Statistics report generated by CashPilot - ${new Date().toLocaleString(getLocale())}</p>
  </div>
</body>
</html>`;
