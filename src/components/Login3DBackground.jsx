 ...
 * Three.js is loaded lazily to keep the login bundle lighter.
 */
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const starMaterial = new THREE.ShaderMaterial({
        ...
        uniforms: {
          uTime: { value: 0 },
          uColor1: { value: new THREE.Color(0x7b61ff) },
          uColor2: { value: new THREE.Color(0xffd67d) },
        },
        vertexShader: `
      ...
      scene.add(new THREE.LineSegments(lineGeo, lineMaterial));
      ...
      const glowMat = new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            vec3 c1 = vec3(0.482, 0.380, 1.0);
            vec3 c2 = vec3(1.0, 0.839, 0.49);
