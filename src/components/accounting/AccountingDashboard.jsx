    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
         ...
         <Card className="bg-gray-900 border-gray-800">
           ...
           <CardContent>
             <div className="text-2xl font-bold text-white">$32,891.89</div>
         ...
         <Card className="bg-gray-900 border-gray-800">
           ...
           <CardContent>
             <div className="text-2xl font-bold text-white">$8,231.00</div>
          ...
          <div className="space-y-2">
             {entries.map(entry => (
               <div key={entry.id} className="flex justify-between items-center p-2 bg-gray-800/50 rounded hover:bg-gray-800 transition">
                 <div>
                   <div className="text-white font-medium">{entry.description || 'Transaction'}</div>
