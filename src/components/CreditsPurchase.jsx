...
const CreditsPurchase = () => {
  ...
  const { credits, availableCredits, transactions, fetchTransactions, unlimitedAccess, unlimitedAccessLabel } =
    useCredits();
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-cyan-100/80 mt-0.5">
                Tous les services et usages credits sont ouverts sans limitation.
              </p>
            </div>
          </div>
        </div>
              ...
              {CREDIT_CATEGORIES.OTHER.map((key) => (
                <div key={key} className="flex justify-between p-2 bg-gray-700/50 rounded">
                  ...
                  <span className="text-yellow-400 font-semibold">
                    {CREDIT_COSTS[key]} {t('credits.credit')}
                  </span>
                </div>
              ))}
            </div>
      ...
      <div>
        <Button
          variant="outline"
          onClick={loadHistory}
          className="border-gray-600 text-gray-300 hover:bg-gray-700 mb-3"
        >
