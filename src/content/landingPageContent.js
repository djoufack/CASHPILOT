export const landingPageContent = {
  fr: {
    ...
    hero: {
      ...
      mcpBanner: "Révolutionnaire dans le monde de la comptabilité et la finance d'entreprise : CashPilot est aussi un serveur MCP, qui offre 169 outils à tout client MCP (ChatGPT, Claude, Gemini, Mistral, n8n, Gumloop), dont l'extraction IA de factures fournisseurs (PDF/image), pour une conversation en temps réel ou pour son intégration dans vos workflows d'automatisation (n8n, Zapier, Rube.app).",
      tags: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'Serveur MCP & API', description: '169 outils MCP (dont extraction IA factures) + API REST pour agents IA et automations' },
    ...
    mcp: {
      ...
      description: "CashPilot est un serveur MCP (Model Context Protocol) avec 169 outils intégrés, dont l'extraction IA de factures fournisseurs. Pilotez votre gestion financière par la voix ou le texte, depuis n'importe quel agent IA.",
      agents: [
      ...
      cards: [
        ...
        { title: '169 outils MCP', description: 'Création de factures, recherche de clients, export comptable, résumé financier, extraction IA de factures fournisseurs — 169 outils accessibles via le protocole MCP standard.' },
    ...
    advantages: {
      ...
      items: [
        ...
        'Serveur MCP : 169 outils dont extraction IA de factures, depuis ChatGPT, Claude, Gemini, Mistral',
  ...
  en: {
    ...
    hero: {
      ...
      mcpBanner: 'A breakthrough for accounting and business finance: CashPilot is also an MCP server that exposes 169 tools to any MCP client (ChatGPT, Claude, Gemini, Mistral, n8n, Gumloop), including AI supplier-invoice extraction (PDF/image), for real-time conversations or integration into your automation workflows (n8n, Zapier, Rube.app).',
      tags: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'MCP server & API', description: '169 MCP tools (including AI invoice extraction) + REST API for AI agents and automations' },
    ...
    mcp: {
      ...
      description: 'CashPilot is an MCP (Model Context Protocol) server with 169 built-in tools, including AI supplier-invoice extraction. Run your finance operations by voice or text from any AI agent.',
      agents: [
        { name: 'Claude', company: 'Anthropic' },
        { name: 'ChatGPT', company: 'OpenAI' },
        { name: 'Gemini', company: 'Google' },
      ...
      cards: [
        ...
        { title: '169 MCP tools', description: 'Invoice creation, client lookup, accounting export, financial summaries, AI supplier-invoice extraction — 169 tools available through the standard MCP protocol.' },
    ...
    advantages: {
      ...
      items: [
        ...
        'MCP server: 169 tools including AI invoice extraction from ChatGPT, Claude, Gemini, and Mistral',
  ...
  nl: {
    ...
    hero: {
      ...
      mcpBanner: 'Een doorbraak in boekhouding en bedrijfsfinanciën: CashPilot is ook een MCP-server die 169 tools aanbiedt aan elke MCP-client (ChatGPT, Claude, Gemini, Mistral, n8n, Gumloop), waaronder AI-extractie van leveranciersfacturen (pdf/afbeelding), voor realtime gesprekken of integratie in uw automatiseringsworkflows (n8n, Zapier, Rube.app).',
      tags: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'MCP-server & API', description: '169 MCP-tools (waaronder AI-factuurextractie) + REST API voor AI-agents en automatiseringen' },
    ...
    mcp: {
      ...
      description: 'CashPilot is een MCP-server (Model Context Protocol) met 169 ingebouwde tools, waaronder AI-extractie van leveranciersfacturen. Stuur uw financiën via stem of tekst vanuit eender welke AI-agent.',
      agents: [
        { name: 'Claude', company: 'Anthropic' },
        { name: 'ChatGPT', company: 'OpenAI' },
        { name: 'Gemini', company: 'Google' },
      ...
      cards: [
        ...
        { title: '169 MCP-tools', description: 'Facturen aanmaken, klanten opzoeken, boekhoudkundige exporten, financiële samenvattingen, AI-extractie van leveranciersfacturen — 169 tools toegankelijk via het standaard MCP-protocol.' },
    ...
    advantages: {
      ...
      items: [
        ...
        'MCP-server: 169 tools waaronder AI-factuurextractie vanuit ChatGPT, Claude, Gemini en Mistral',
