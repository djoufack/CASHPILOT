export const landingPageContent = {
  fr: {
    ...
    features: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            '461 outils MCP (finance + projets + CRM + RH + matériel + extraction IA factures) + API REST pour agents IA et automations',
        },
        {
          title: 'MFA / 2FA (TOTP)',
    ...
    mcp: {
      ...
      cards: [
        ...
        {
          title: '461 outils MCP',
          description:
            'Finance, projets, CRM, ressources humaines, matériel, extraction IA de factures fournisseurs — 461 outils accessibles via le protocole MCP standard.',
        },
        {
    ...
    advantages: {
      ...
      items: [
        ...
        'Serveur MCP : 461 outils (finance, projets, CRM, RH, matériel) dont extraction IA de factures, depuis ChatGPT, Claude, Gemini, Mistral',
  ...
  en: {
    ...
    features: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            '461 MCP tools (finance + projects + CRM + HR + equipment + AI invoice extraction) + REST API for AI agents and automations',
        },
    ...
    mcp: {
      ...
      description:
        'CashPilot is an MCP (Model Context Protocol) server with 461 built-in tools covering finance, projects, CRM (leads/tickets/SLA), human resources (HR), equipment, and AI supplier-invoice extraction. Run your entire business by voice or text from any AI agent.',
      agents: [
        { name: 'Claude', company: 'Anthropic' },
        { name: 'ChatGPT', company: 'OpenAI' },
        { name: 'Gemini', company: 'Google' },
      ...
      cards: [
        ...
        },
        {
          title: '461 MCP tools',
          description:
            'Finance, projects, CRM, human resources, equipment, AI supplier-invoice extraction — 461 tools available through the standard MCP protocol.',
        },
        {
    ...
    advantages: {
      ...
      items: [
        ...
        'MCP server: 461 tools (finance, projects, CRM, HR, equipment) including AI invoice extraction from ChatGPT, Claude, Gemini, and Mistral',
  ...
  nl: {
    ...
    hero: {
      ...
      mcpBanner:
        'Een doorbraak in bedrijfsbeheer: CashPilot is ook een MCP-server die 461 tools aanbiedt aan elke MCP-client (ChatGPT, Claude, Gemini, Mistral, n8n, Gumloop), voor finance, projecten, CRM (leads/tickets/SLA), human resources (HR), materieel en AI-extractie van leveranciersfacturen (pdf/afbeelding), voor realtime gesprekken of integratie in uw automatiseringsworkflows (n8n, Zapier, Rube.app).',
      tags: {
    ...
    features: {
      ...
      cards: [
        ...
        },
        {
          title: 'MCP-server & API',
          description:
            '461 MCP-tools (finance + projecten + CRM + HR + materieel + AI-factuurextractie) + REST API voor AI-agents en automatiseringen',
        },
    ...
    mcp: {
      ...
      description:
        'CashPilot is een MCP-server (Model Context Protocol) met 461 ingebouwde tools voor finance, projecten, CRM (leads/tickets/SLA), human resources (HR), materieel en AI-extractie van leveranciersfacturen. Bestuur uw volledige bedrijf via stem of tekst vanuit eender welke AI-agent.',
      agents: [
        { name: 'Claude', company: 'Anthropic' },
        { name: 'ChatGPT', company: 'OpenAI' },
        { name: 'Gemini', company: 'Google' },
      ...
      cards: [
        ...
        },
        {
          title: '461 MCP-tools',
          description:
            'Finance, projecten, CRM, human resources, materieel, AI-extractie van leveranciersfacturen — 461 tools toegankelijk via het standaard MCP-protocol.',
        },
        {
    ...
    advantages: {
      ...
      items: [
        ...
        'MCP-server: 461 tools (finance, projecten, CRM, HR, materieel) waaronder AI-factuurextractie vanuit ChatGPT, Claude, Gemini en Mistral',
