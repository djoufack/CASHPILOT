...
const OnboardingPage = () => {
  ...
  const handleToggleTask = useCallback(
    ...
    [selectedPlan, updateOnboardingTask, toast]
  );
  ...
  }, [newPlanForm, createOnboardingPlan, toast]);
  ...
  const renderPlanDetail = () => {
    ...
    const st = STATUS_MAP[selectedPlan.status] || STATUS_MAP.active;
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-semibold text-white">{selectedPlan.plan_name || "Plan d'onboarding"}</h2>
  ...
  const renderPlansList = () => (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        >
          <Plus className="w-4 h-4 mr-1.5" /> Nouveau plan
        </Button>
      </div>
                ...
                <CardHeader className="pb-2">
                  <div className="flex items-start justify-between gap-2">
                    <CardTitle className="text-base text-white leading-snug">
                      {plan.plan_name || "Plan d'onboarding"}
                    </CardTitle>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {mentor && (
                      <p className="text-sm text-gray-500 flex items-center gap-1.5">
                        <Users className="w-3.5 h-3.5" /> Mentor : {getEmployeeLabel(mentor)}
                      </p>
                    )}
                  </div>
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center">
        <div className="animate-pulse text-gray-400">Chargement de l'onboarding...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a]">
      <Helmet>
        <title>Onboarding | CashPilot</title>
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          <Card className="bg-white/5 border-white/10">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Plans actifs</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white/5 border-white/10">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Progression moy.</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-white/5 border-white/10">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-gray-400">Total plans</CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <Dialog open={createDialog} onOpenChange={setCreateDialog}>
        <DialogContent className="sm:max-w-lg bg-[#0f1528] border-white/10 text-white">
          <DialogHeader>
            <DialogTitle>Nouveau plan d'onboarding</DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
