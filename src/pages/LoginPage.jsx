              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <a href="#" className="text-xs text-blue-400 hover:text-blue-300">Mot de passe oublié?</a>
                  </div>
                  <div className="relative">
                    <Input 
                      ...
                      className="bg-gray-900/50 border-gray-700 text-white pr-10 focus:border-blue-500"
                      placeholder="••••••••"
                      disabled={loading}
                    />
                    <button
