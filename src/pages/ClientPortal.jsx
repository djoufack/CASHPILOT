            ...
            <div className="min-h-screen bg-gray-950">
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gray-900 p-6 rounded-xl border border-gray-800">
                            ...
                            <div className="space-y-4">
                                <div className="p-4 bg-gray-800 rounded-lg flex justify-between items-center">
                                    ...
                                    <span className="px-2 py-1 bg-green-900/50 text-green-400 rounded text-xs">{t('clientPortal.paid', 'Paid')}</span>
                                </div>
                                <div className="p-4 bg-gray-800 rounded-lg flex justify-between items-center">
                                    <div>
                        ...
                        <div className="bg-gray-900 p-6 rounded-xl border border-gray-800">
                            <h2 className="text-xl font-bold text-gradient mb-4 flex items-center">
                                <CheckCircle className="mr-2 text-orange-400" /> {t('clientPortal.pendingApprovals', 'Pending Approvals')}
                            </h2>
