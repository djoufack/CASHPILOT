    ...
    <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-gray-950 text-white space-y-6">
      ...
      <Tabs defaultValue="dashboard" className="w-full">
        <TabsList className="w-full bg-gray-900 border-gray-800 overflow-x-auto flex-nowrap justify-start h-auto p-1">
          <TabsTrigger value="dashboard" className="flex-1 min-w-[100px] data-[state=active]:bg-orange-500/10 data-[state=active]:text-orange-400">
            <BarChart3 className="w-4 h-4 mr-2" /> Dashboard
          </TabsTrigger>
          <TabsTrigger value="coa" className="flex-1 min-w-[100px] data-[state=active]:bg-orange-500/10 data-[state=active]:text-orange-400">
            <FileText className="w-4 h-4 mr-2" /> Chart of Accounts
          </TabsTrigger>
          <TabsTrigger value="mappings" className="flex-1 min-w-[100px] data-[state=active]:bg-orange-500/10 data-[state=active]:text-orange-400">
            <Settings className="w-4 h-4 mr-2" /> Mappings
          </TabsTrigger>
          <TabsTrigger value="tax" className="flex-1 min-w-[100px] data-[state=active]:bg-orange-500/10 data-[state=active]:text-orange-400">
        ...
        <TabsContent value="mappings" className="mt-6">
           <div className="p-8 text-center bg-gray-900/50 border border-gray-800 rounded-lg text-gray-500">
              ...
              <h3 className="text-lg font-medium text-gradient">Mapping Configuration</h3>
        ...
        <TabsContent value="tax" className="mt-6">
            <div className="p-8 text-center bg-gray-900/50 border border-gray-800 rounded-lg text-gray-500">
              ...
              <h3 className="text-lg font-medium text-gradient">Tax Rates</h3>
