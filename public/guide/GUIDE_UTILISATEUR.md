...
3. Utilisez `mcp_toolset` pour que Claude accede aux 169 outils CashPilot
...
_Version 2.0 - Février 2026 — 19 nouvelles fonctionnalités (MFA, GDPR, Onboarding, Email, IA, Banque, API, Performance)_
